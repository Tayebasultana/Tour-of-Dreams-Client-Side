...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // else {
    //     toast.alert('Captcha Does Not Match');
    // }
  ...
  return (
    ...
    >
      <div className="bg-transparent p-8 md:p-12 rounded-lg shadow-lg max-w-4xl flex flex-col lg:flex-row gap-8 items-center">
        ...
        <div className="w-full">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full bg-yellow-500 text-white py-2 rounded-md shadow hover:bg-yellow-600 focus:ring focus:ring-yellow-500 transition-all"
            >
              Login
            </button>
          </form>
